import { a as useRuntimeConfig, e as withLeadingSlash, j as joinURL, b as withoutTrailingSlash, d as withBase } from './server.mjs';
import { a as useRequestEvent, h as hash, u as useContentPreview } from './preview-BRwDANKP.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-C7m241iR.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DOiAukD4.mjs.map
