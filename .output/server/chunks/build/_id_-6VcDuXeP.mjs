...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)}><div class="ql-snow max-w-3xl m-auto px-3"><div class="ql-editor"><div>${ssrInterpolate(unref(result).title)}</div><div class="">${unref(result).content}</div></div></div></section>`);
    };
  }
};
...
//# sourceMappingURL=_id_-6VcDuXeP.mjs.map
