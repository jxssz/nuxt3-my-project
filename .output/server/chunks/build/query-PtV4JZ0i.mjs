import { a as useRuntimeConfig, f as withLeadingSlash, j as joinURL, c as withoutTrailingSlash, e as withBase } from './server.mjs';
import { a as useRequestEvent, h as hash, u as useContentPreview } from './preview-CxxoWWG6.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db--72PQJbg.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-PtV4JZ0i.mjs.map
