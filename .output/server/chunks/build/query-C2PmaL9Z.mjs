import { a as useRuntimeConfig, g as withLeadingSlash, j as joinURL, d as withoutTrailingSlash, f as withBase } from './server.mjs';
import { a as useRequestEvent, h as hash, u as useContentPreview } from './preview-BYirarPZ.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CkSy-T9J.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-C2PmaL9Z.mjs.map
